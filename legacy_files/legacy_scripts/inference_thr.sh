...
python /data/ephemeral/home/pro-cv-semanticsegmentation-cv-11/inference.py \
    ...
    --thr 0.5 \
    --thr_dict /data/ephemeral/home/pro-cv-semanticsegmentation-cv-11/scripts/basic_runners/class_thresholds_hard.json \
    --output /data/ephemeral/home/pro-cv-semanticsegmentation-cv-11/outputs/HRNet_W18/hrnet_w18_aug_elastic_3_stage-best_28epoch_0.9720_classwise_thr_hard.csv \
    --resize 1024 \
    --batch_size 1