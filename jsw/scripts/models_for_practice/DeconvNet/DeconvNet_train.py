...
WANDB_SUBNAME = "DeconvNet"
CHECKPOINT_NAME = 'DeconvNet_best_model.pt'
...
train_loader = DataLoader(
    ...
    shuffle=True,
    num_workers=4, # 배치가 작고 augmentation이 많으면 num_workers=2~8 추천
    drop_last=True,
)
...
class DeconvNet(nn.Module):
    def __init__(self, num_classes=len(CLASSES)):
        ...
        # TODO: DeconvNet 모델을 완성하기 위해 필요한 모듈들을 작성하세요
        pass
    ...
    def forward(self, x):
        ...
        pass
model = DeconvNet(num_classes=len(CLASSES))
#endregion
